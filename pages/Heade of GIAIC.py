...
with toggles[0]:
 SirZia = st.toggle("Sir Zia Khan")
with toggles[1]:
 MissHira = st.toggle("Miss Hira khan")
with toggles[2]:
 SirDaniyal = st.toggle("Sir Daniyal Nagori")
with toggles[3]:
 SirAmeen = st.toggle("Sir Ameen Alam")


if SirZia:
    st.image('sirZiakhan.jpg',caption='MR. ZIA KHAN')
...
# ---------------------------------------------------------------------------------------
if MissHira:
    st.image('MissHirakhan.jpg',caption='Chief Operating Officer in PIAIC Miss Hira')
...
# ---------------------------------------------------------------------------------------
if SirDaniyal:
    st.image('SirDaniyal.jpg',caption=' MR. Daniyal Nagori')
...
# --------------------------------------------------------------------------------------
if SirAmeen:
    st.image('SirAmeen.jpg',caption=' MR. Ameen Alam Bank Al-Beilaad UAE')
...
# SirAli = st.toggle("Sir Ali Raza")
# SirFaraz = st.toggle("Sir Faraz")
# SirZain = st.toggle("Sir Zain")
# SirNoman = st.toggle("Sir Noman")
# SirUsman = st.toggle("Sir Usman")
